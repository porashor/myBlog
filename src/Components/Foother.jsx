  ...
  return (
    <div className='py-20 bg-[#0a022b] text-white'>
      <div className='w-[85%] mx-auto'>
        <div className='grid lg:grid-cols-[7fr_3fr] border-b border-neutral-700 pb-4'>
            <div className='grid md:grid-cols-2 lg:grid-cols-4 items-start justify-start'>
                {
            ...
            <div className='grid items-center gap-4'>
                ...
                <div className='grid xl:grid-cols-[7fr_3fr] items-center'>
                    ...
                    <Button className={`border mx-2 h-[50px] hover:gradient hover:border-yellow-700`}>Subscribe</Button>
                </div>
        ...
        <div className='flex justify-between items-center py-4'>
            <div className='text-md text-neutral-400'>@ Copyright 2023| All right reserved</div>
